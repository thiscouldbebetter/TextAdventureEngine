	...
	static worldBuild()
	{
		...
		[
			...
			(
				...
				[
					new Portal("east", portalDescription, "Eastern Room"),
					new Portal("north", portalDescription, "Northern Room"),
					new Portal("south", portalDescription, "Southern Room"),
					new Portal("west", portalDescription, "Western Room")
				]
			),
			p
			(
				...
				[
					new Portal("west", portalDescription, "Center Room"),
					new Emplacement
					(
						"chest",
			...
			(
				...
				[
					new Portal("south", portalDescription, "Center Room"),
			...
			(
				...
				[
					new Portal("north", portalDescription, "Center Room"),
					new Item
					(
						"key",
			...
			(
				...
				[
					new Portal("east", portalDescription, "Center Room"),
					new Item
					(
						"whetstone",
