...
class Game {
    static worldBuild() {
        ...
        var p = (name, description, objects) => Place.fromNameDescriptionAndObjects(name, description, objects);
        ...
        var placeCenterRoom = Place.fromNameDescriptionScriptNameAndObjects(placeCenterRoomName, "This is the room you landed in when your captor threw you down here."
            + "  There are doors to the north, south, east, and west.", scriptsCustom.PlaceCenterRoomUpdate.name, [
            Emplacement.fromNameAndDescription("pool", "This is a shallow, dirty, foul-smelling pool of water."),
            ...
            new Agent("captor", "Your captor lingers by the trap door, waiting for you to retrieve his property.", scriptsCustom.AgentCaptorUpdate.name, null, // items
            [
        ...
        var placeEasternRoom = p(placeEasternRoomName, "This room is east of the center.  A doorway to the west leads back to the Center Room.", [
            ...
            Emplacement.fromNameDescriptionAndScriptUse("chest", "This is a sturdy, and very heavy, oaken chest with a lock.", scriptsCustom.EmplacementChestUse)
        ]);
        var placeNorthernRoom = p("Northern Room", "This room is north of the center.  A doorway to the south leads back to the Center Room.", [
            ...
            Agent.fromNameAndDescription("troll", "The scabrous troll leers malevolently at you.")
        ]);
        var placeSouthernRoom = p("Southern Room", "This room is south of the center.  A doorway to the north leads back to the Center Room.", [
            ...
            Item.fromNameDescriptionAndScriptUse("key", "This is a large brass key.", scriptsCustom.ItemKeyUse)
        ]);
        var placeWesternRoom = p("Western Room", "This room is west of the center.  A doorway to the east leads back to the Center Room.", [
            ...
            Item.fromNameDescriptionAndScriptUse("whetstone", "This is a flat stone for sharpening tools and weapons.", scriptsCustom.ItemWhetstoneUse)
        ]);
        var places = [
            placeCenterRoom,
            placeEasternRoom,
...
class Scripts {
    ...
    emplacementChestUse(u, w, place, emplacement) {
        ...
        if (isUnlocked != true) {
            ...
            var itemSword = Item.fromNameDescriptionAndScriptUseName("sword", "This is a steel sword, too dull to cut anything.", "ItemSwordUse");
    ...
    emplacementTrollBodyUse(u, w, place, emplacementTrollBody, target) {
        ...
        if (target != null) {
            ...
            var itemCoin = Item.fromNameAndDescription("coin", "This is a gold coin.");
    ...
    itemCoinGiveToCaptor(universe, world, place) {
        ...
        if (itemCoin == null) {
            ...
            var itemRope = Item.fromNameAndDescription("rope", "This is a coil of weathered hempen rope.");
    ...
    itemSwordUse(u, w, place, item, target) {
        if (target == null) {
        ...
        else if (item.stateGroup.valueGetByName(StateNames.isSharpened()) != true) // hack
         {
            ...
            var emplacementTrollBody = Emplacement.fromNameDescriptionAndScriptUseName("troll body", "This is the headless corpse of the troll, naked except for a small coin purse.", "EmplacementTrollBodyUse");
            place.emplacementAdd(emplacementTrollBody);
            var itemTrollHead = new Item("troll head", "This is the head of the troll you killed.", null, // scriptNameUse
            null, // stateGroup
            [
                new Command(["talk to troll", "talk to the troll", "talk to troll head", "talk to the troll head"], "ItemTrollHeadTalkTo")
            ]);
